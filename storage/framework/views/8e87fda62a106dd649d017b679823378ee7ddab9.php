<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <a href="<?php echo e(route('pdf')); ?>" class="btn btn-primary" target="_blank">CETAK PDF</a>
            <a href="<?php echo e(route('excel')); ?>" class="btn btn-primary" target="_blank">CETAK EXCEL</a>
